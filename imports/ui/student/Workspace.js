...
const RednerNavigation = () => {
  const { currentTask, getPrevTask, getNextTask, getSolution } = useTasksContext();
  ...
  return (<>
    <button className="navigation-button" id="navigation-button-left" onClick={getPrevTask}><Icon name="arrow-left" size="large" /></button>
    {showSubmit && <button className="navigation-button" id="navigation-button-submit" onClick={getSolution}>AUSWERTEN</button>}
    <button className="navigation-button" id="navigation-button-right" onClick={getNextTask}><Icon name="arrow-right" size="large" /></button>
  </>)
}
